			...
			>
				...
				<div className="hidden items-center gap-1 md:flex">
					...
					<div className="flex items-center gap-4 border-l border-white/10 pl-4">
						<Link href="/sign-in" className={cn(buttonVariants({ variant: 'ghost' }), "text-white/70 hover:text-white text-xs lg:text-sm")}>
							Sign In
						</Link>
						<Link 
							href="/get-started"
							className="bg-white text-black hover:bg-white/90 shadow-lg text-xs lg:text-sm px-5 rounded-full font-semibold flex items-center h-10"
						>
							Get Started
						</Link>
					</div>
			...
			>
				<div className="flex h-full w-full flex-col justify-between gap-y-8 p-8 overflow-y-auto">
					...
					<div className="flex flex-col gap-4 mb-20">
						<Link href="/sign-in" onClick={() => setOpen(false)} className={cn(buttonVariants({ variant: 'outline' }), "w-full text-lg py-7 border-white/20 text-white rounded-xl h-auto")}>
							Sign In
						</Link>
						<Link 
							href="/get-started"
							onClick={() => setOpen(false)}
							className="w-full text-lg py-7 bg-white text-black rounded-xl font-bold flex items-center justify-center h-auto"
						>
							Get Started
						</Link>
					</div>
