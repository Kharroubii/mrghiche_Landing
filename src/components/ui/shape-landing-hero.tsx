        ...
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#030303]">
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6 pt-40 md:pt-56">
                <div className="max-w-3xl mx-auto text-center">
                    <MotionDiv custom={0} variants={fadeUpVariants} initial="hidden" animate="visible" className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.03] border border-white/[0.08] mb-8 md:mb-12">
                        <Circle className="h-2 w-2 fill-rose-500/80" />
                        <span className="text-sm text-white/60 tracking-wide">{badge}</span>
                    </MotionDiv>
                    <MotionDiv custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
                    ...
                    <MotionDiv custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
                        <MotionP className="text-base sm:text-lg md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">{description}</MotionP>
                    </MotionDiv>
                </div>
            </div>
